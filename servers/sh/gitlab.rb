...
external_url 'http://120.26.208.69:4401/gitlab'
...
#email gitlab_rails['gitlab_email_enabled'] = true
email gitlab_rails['gitlab_email_from'] = '1219331697@qq.com'
...
gitlab_rails['smtp_user_name'] = "1219331697"
gitlab_rails['smtp_password'] = "whqycvkxynxrbaad"
#gitlab_rails['smtp_domain'] = "qq.com"
gitlab_rails['smtp_authentication'] = "login"
gitlab_rails['smtp_enable_starttls_auto'] = true
## 修改gitlab配置的发信人,
## qq、163；smtp机器要求身份验证帐号和发信帐号必须一致，
## 如果用户在发送邮件时，身份验证帐号和发件人帐号是不同的，拒绝发送。
#gitlab_rails['gitlab_email_from'] = "1219331697@qq.com"
#user["git_user_email"] = "1219331697@qq.com"
